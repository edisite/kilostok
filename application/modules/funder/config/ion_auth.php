...
*/
$config['tables']['users']           = 'funder_users';
$config['tables']['groups']          = 'funder_groups';
$config['tables']['users_groups']    = 'funder_users_groups';
$config['tables']['login_attempts']  = 'funder_login_attempts';
 ...
 */
$config['site_title']                 = "Funder Panel";       // Site Title, example.com
$config['admin_email']                = "kilostok.info@gmail.com"; // Admin Email, admin@example.com
...
$config['lockout_time']               = 60000;                 // The number of seconds to lockout an account due to exceeded attempts
