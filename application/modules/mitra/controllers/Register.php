...
class Register extends MY_Controller {
        ...
        public function index()
	{
		...
		if ($form->validate())
		{
			...
			$user = $this->ion_auth->register($username, $password, $email, $additional_data, $groups,TRUE,$nama_perusahaan);
                        if ($user)
			{
				// success
			...
			refresh();
                        //object(Ion_auth)#17 (4) { ["status":protected]=> NULL ["_extra_where"]=> array(0) { } ["_extra_set"]=> array(0) { } ["_cache_user_in_group"]=> &array(1) { [20]=> array(1) { [1]=> string(7) "manager" } } }
