	                    ...
	                    <form class="form form-horizontal">
	                    	<div class="form-body">
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-8">			                            
                                                    <input type="text" class="form-control" name="barang_nama" placeholder="Nama Barang" required />                                                        
                                                </div>
		                        </div>
                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-8">			                            
                                                    ...
                                                    <select class="form-control" id="m_kategori_barang_id" name="m_kategori_barang_id"  aria-required="true" aria-describedby="select-error" required></select>
                                                </div>
                                                </div>
		                        </div>
<!--                                        <div class="form-group row">
                                                ...
                                                <div class="col-md-8">			                            
                                                    <div class="input-icon right">                                                   
                                                    <select class="select2-data-ajax form-control" id="m_satuan_barang_id" name="m_satuan_barang_id"  aria-required="true" aria-describedby="select-error" required></select>
                                                </div>
                                                </div>
		                        </div>-->
                                        <div class="form-group row">
