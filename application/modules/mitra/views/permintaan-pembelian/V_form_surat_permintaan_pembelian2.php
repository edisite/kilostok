                            ...
                            <div class="portlet light portlet-fit portlet-datatable bordered">
                                ...
                                <form action="#" id="formAdd" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <input type="hidden" id="url" value="Persetujuan/Surat-Permintaan-Pembelian/postData/">
                                        <input type="hidden" id="url_data" value="Persetujuan/Surat-Permintaan-Pembelian">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-4">Departemen Permintaan
                                                <span class="required"> * </span>
                                            </label>
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <textarea class="form-control" rows="3" name="permintaan_pembelian_catatan" readonly required></textarea> </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-4">Status SPP Saat ini 
                                        </label>
                                        <div class="col-md-8">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <div id="status_spp" class="form-control"></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            <div class="input-icon right">
                                                <i class="fa"></i>
                                                <div id="setuju_spp" hidden="true">
                                                    <label class="mt-checkbox"> Setujui SPP
                                                        <input type="checkbox" value="1" id="persetujuan1" onclick="checkPersetujuan();" />
                                                        <span></span>
                                                    </label>
                                                </div>
                                                <div id="batalkan_spp" hidden="true">
                                                    <label class="mt-checkbox"> Batalkan Persetujuan SPP
                                    ...
                                    <div class="form-actions">
                                        <div class="row">
                                            <div class="col-md-offset-4 col-md-8 text-right">
                                                ...
                                                <a href="<?php echo base_url();?>Persetujuan/Surat-Permintaan-Pembelian">
        ...
        <script type="text/javascript">
            ...
            function editData(id) {
                $.ajax({
                  type : "GET",
                  url  : '<?php echo base_url();?>Persetujuan/Surat-Permintaan-Pembelian/loadDataWhere/',
                  data : "id="+id,
                  dataType : "json",
                  success:function(data){
                    for(var i=0; i<data.val.length;i++){
                      ...
                      if (data.val[i].permintaan_pembelian_status > 5) {
                        document.getElementById('submit'). disabled = true;
                      }

                      if (data.val[i].permintaan_pembelian_status == 2) {
                        $("#status_spp").html('SPP telah diterima');
                        $("#setuju_spp").attr('hidden', false);
                        $("#batalkan_spp").attr('hidden', true);
                      } else if(data.val[i].permintaan_pembelian_status == 3) {
                        $("#status_spp").html('SPP direvisi');
                        $("#setuju_spp").attr('hidden', false);
                        $("#batalkan_spp").attr('hidden', true);
                      } else if(data.val[i].permintaan_pembelian_status == 4) {
                        $("#status_spp").html('SPP tidak disetujui');
                        $("#setuju_spp").attr('hidden', false);
                        $("#batalkan_spp").attr('hidden', true);
                      } else if (data.val[i].permintaan_pembelian_status == 5) {
                        $("#status_spp").html('SPP disetujui');
                        $("#setuju_spp").attr('hidden', true);
                        $("#batalkan_spp").attr('hidden', false);
                      } else if(data.val[i].permintaan_pembelian_status == 6){
                        $("#status_spp").html('SPP Berjalan');
                        $("#kolomPersetujuan").attr('hidden', true);
                      } else if(data.val[i].permintaan_pembelian_status == 7){
                        $("#status_spp").html('SPP Selesai');
                        $("#kolomPersetujuan").attr('hidden', true);
                      }
                      ...
                      document.getElementsByName('m_jenis_barang_id')[0].disabled = true;
            ...
            function checkPersetujuan() {
                if (document.getElementById("persetujuan1").checked == true) {
                    document.getElementsByName("permintaan_pembelian_status")[0].value = 5;
                } else if(document.getElementById("persetujuan2").checked == true){
                    document.getElementsByName("permintaan_pembelian_status")[0].value = 4;
                } else {
                    document.getElementsByName("permintaan_pembelian_status")[0].value = 2;
                }
            }
        </script>
