...
class Produk_kategori extends MY_Controller {
	...
	public function view(){
			$this->render('masterdata/produk_kategori/V_kategori');
	}
	public function loadData(){
		...
		$where_like['data'][] = array(
			'column' => '`kategori_id`, `kategori_nama`, `m_kategori_gudang_id`, `kategori_status_aktif`, `kategori_create_date`, `kategori_create_by`, `kategori_update_date`, `kategori_update_by`',
		...
		if ($query<>false) {
			...
			foreach ($query->result() as $val) {
				...
				$response['data'][] = array(			
					$val->kategori_id,
					$val->kategori_nama,
					$val->kategori_status_aktif,
					$val->kategori_create_date,
					$val->kategori_create_by,
					$button
				);
				$no++;
			}
